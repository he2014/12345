  ...
  <el-table
    ...
    <el-table-column prop="operationsMapName"  label="LOGO">
       <template scope="scope">
          <img
             width="50px"
             src="https://expressprod.oss-cn-hangzhou.aliyuncs.com/SendAppLogo/73d989b5-1477-4135-8679-2965eaf74224.png">
       </template>
    </el-table-column>
    <el-table-column prop="operationsMapName"  label="快递资源名称">
    </el-table-column>
    <el-table-column prop="operationsMapName"  label="广告语">
    </el-table-column>
    <el-table-column prop="operationsMapName"  label="标签">
    </el-table-column>
...
export default {
  ...
  methods: {
    ...
    setNewData() {
      this.$router.push('/nearExpress/addData')
    },
    handleClose() {
      alert("asdfsd");
    },
