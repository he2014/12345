...
<section class="section">
  ...
  <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px"  style="width:800px;padding-left:100px">
    <el-form-item label="资源名称" prop="photoName">
      <el-input v-model.trim="ruleForm.photoName" placeholder="请输入资源名称"> </el-input>
    </el-form-item>
...
<el-button v-else class="button-new-tag" size="small" @click="showInput">+ New Tag</el-button>
    ...
    <el-form-item label="广告语" prop="ad">
      <el-input v-model.number="ruleForm.ad" placeholder="请输入广告语"> </el-input>
    </el-form-item>
