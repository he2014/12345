...
<section class="section editData-class">
  ...
  <el-form ref="form" :model="form" label-width="100px"  style="width:800px;padding-left:100px">
    ...
    <el-form-item label="描述">
      <el-input v-if="isFromAddData" v-model="form.content" placeholder="请输入描述内容"> </el-input>
    ...
    <el-form-item label="跳转链接">
      <el-input v-if="isFromAddData" v-model="form.link" placeholder="请输入需要跳转的链接，如果跳转外部链接必须以http://开头"> </el-input>
...
export default {
  ...
  created() {
    if ( this.$route.path == "/chooseExpressOrder/detail"
          || this.$route.path == "/chooseExpressOrder/detail"
          || this.$route.path == "/chooseExpressOrder/detail") {
