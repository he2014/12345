...
<div id="app">
  ...
  <div style="display:flex;flex-direction:row;">
    ...
    <div style="padding:20px;padding-left:290px;padding-top:20px;flex:1;background:#f1f1f1;">
      ...
      <el-breadcrumb style="padding:10px 0 25px;font-size:16px;line-height:100%;margin-bottom:20px;border-bottom:1px solid #999;" separator="/">
        ...
        <el-breadcrumb-item  v-for="(item,index) in $route.matched" :to="{path:item.path==''?'/':item.path}" :key="item.path" style="color:red;">
          {{item.name}}
        </el-breadcrumb-item>
